...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 w-full border-b-2 border-amber-600 bg-zinc-950/95 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/80">
      <div className="w-full max-w-6xl mx-auto flex h-20 items-center justify-start px-6 md:px-10 lg:px-16">
        {/* Logo - Centered */}
        <Link href="/" className="flex items-center space-x-3 group">
          <div className="relative">
            ...
            <div className="relative flex items-center justify-center w-12 h-12 bg-zinc-900 rounded-lg border-2 border-amber-600/50 group-hover:border-amber-500 transition-colors">
              <svg
                ...
                className="w-7 h-7 text-amber-500 group-hover:text-amber-400 transition-colors"
              >
          ...
          <div className="flex flex-col">
            <span className="text-xl font-bold tracking-wider bg-gradient-to-r from-amber-400 via-orange-500 to-amber-600 bg-clip-text text-transparent">
              THE FORGE
            </span>
            <span className="text-[10px] text-amber-600/80 tracking-widest font-semibold">
              CODES & GUIDES
            </span>
          </div>
        </Link>
